...
namespace Dash.Controllers
{
    public class VendedoresController : Controller
    {
        ...
        public VendedoresController(DemoContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Nome,Area")] Vendedores vendedores)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nome,Area")] Vendedores vendedores)
        {
            if (id != vendedores.Id)
            {
                return NotFound();
